...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($class_name)) {
        ...
        $insert_query = "INSERT INTO classes (teacher_id, class_name, description, access_code) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($insert_query);
        $stmt->bind_param("isss", $teacher_id, $class_name, $description, $access_code);
